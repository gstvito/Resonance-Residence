...
const PropertyDetail = () => {
  ...
  const propertyUnits = [
    ...
    },
    {
      ...
      image: "/Tipe2.png",
      features: ["Ruang tamu", "Ruang keluarga", "2 Kamar tidur", "2 Kamar mandi", "Dapur", "Teras", "Carport"],
      available: 18,
      description: "Rumah ideal untuk keluarga berkembang dengan 2 kamar tidur dan 2 kamar mandi.",
      freeFurniture: [
        "SOFA RUANG TAMU",
        "SPRING BED 200 X 200",
        "LEMARI PAKAIAN 2 PINTU",
